...
(function () {
  ...
  var closeburgerBtn = document.querySelector('.close-menu-btn');
  var sidebar = document.querySelector('.side-bar');
  var bodycontent = document.querySelector('.body-content'); // const maincontent = document.querySelector('.main-content')
  ...
  burgerBtn.addEventListener('click', function () {
    openSidebar();
    pagecontent.addEventListener('click', closeSidebar, sidebar.classList.contains('side-bar--opened'));
...
(function () {
  var formContent = document.querySelector('#form-template').content;
  var callBtns = document.querySelectorAll('.call-btn');
  var chatBtns = document.querySelectorAll('.chat-btn');
  var newFormTemplate = formContent.querySelector('.form-container');
  var formDestination = document.querySelector('.form-wrapper'); // const formCloseBtn = document.querySelector('.form-container__close-btn')

  var pagecontent = document.querySelector('.page-content');
  var bodycontent = document.querySelector('.body-content');
  var sidebar = document.querySelector('.side-bar'); //creating forms out of template

  function createForm(heading, removingItemsArray) {
    var result = newFormTemplate.cloneNode(true);

    if (removingItemsArray) {
      var inputsArray = result.querySelectorAll('.form__input');

      for (var i = 0; i < inputsArray.length; i++) {
        for (var j = 0; j < removingItemsArray.length; j++) {
  ...
  var feedBackForm = createForm('Обратная связь');
  var callForm = createForm('Заказать звонок', ['form__name', 'form__email', 'form__textarea']); // setting up form's opening/closing logic
      ...
      btnsArray[i].addEventListener('click', function () {
        ...
        pagecontent.addEventListener('click', function () {
          if (!formDestination.classList.contains('form-wrapper--opened')) {
            pagecontent.removeEventListener('click', _this);
          } else closeForm();
        }, formDestination.classList.contains('form-wrapper--opened'));
        form.querySelector('.form-container__close-btn').addEventListener('click', closeForm);
      });
    }
  }
...
/***/ "./src/js/description-show-btn.js":
/*!****************************************!*\
  !*** ./src/js/description-show-btn.js ***!
  \****************************************/
/*! no static exports found */
...
(function () {
  var textContainer = document.querySelector('.description__text-container');
  var textItems = document.querySelectorAll('.description__text');
  var hiddenSpan = document.querySelector('.description__text--768hidden');
  var showBtn = document.querySelector('.description__showbtn');
  var showBtnImgContainer = document.querySelector('.description__showbtn-img-container');

  function revealHiddenText() {
    if (!textContainer.classList.contains('description__text-container--opened')) {
      ...
      showBtnImgContainer.classList.add('description__showbtn-img-container--flipped');
      showBtn.querySelector('.description__showbtn-text').textContent = 'Скрыть';
    } else {
      for (var _i = 0; _i < textItems.length; _i++) {
        textItems[_i].removeAttribute('style');
      }

      hiddenSpan.removeAttribute('style');
      textContainer.classList.remove('description__text-container--opened');
      showBtnImgContainer.classList.remove('description__showbtn-img-container--flipped');
      showBtn.querySelector('.description__showbtn-text').textContent = 'Читать далее';
    }
  }
...
/* harmony import */ var _show_all_btn__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./show-all-btn */ "./src/js/show-all-btn.js");
/* harmony import */ var _show_all_btn__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_show_all_btn__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _burger_btn__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./burger-btn */ "./src/js/burger-btn.js");
/* harmony import */ var _burger_btn__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_burger_btn__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _create_form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./create-form */ "./src/js/create-form.js");
/* harmony import */ var _create_form__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_create_form__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _description_show_btn__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./description-show-btn */ "./src/js/description-show-btn.js");
/* harmony import */ var _description_show_btn__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_description_show_btn__WEBPACK_IMPORTED_MODULE_5__);
...
{
  var showListHandler = function showListHandler(selectedBtn, selectedList, openedListClass, closedListClass, btnTextContainer, btnImgContainer, btnImgClassAdded) {
  ...
  //repair brands
  var repairbrandsList = document.querySelector('.repair-brands__list');
  var repairbrandsShowBtn = document.querySelector('.repair-brands__showbtn');
  var repairbrandsShowBtnTextContainer = repairbrandsShowBtn.querySelector('.repair-brands__showbtn-text');
  var repairbrandsShowBtnImgContainer = repairbrandsShowBtn.querySelector('.repair-brands__showbtn-img-container'); //repair devices

  var repairdevicesList = document.querySelector('.repair-devices__list');
  var repairdevicesShowBtn = document.querySelector('.repair-devices__showbtn');
  var repairdevicesShowBtnTextContainer = repairdevicesShowBtn.querySelector('.repair-devices__showbtn-text');
  var repairdevicesShowBtnImgContainer = repairdevicesShowBtn.querySelector('.repair-devices__showbtn-img-container');
  showListHandler(repairbrandsShowBtn, repairbrandsList, 'repair-brands__list--opened', 'repair-brands__list--closed', repairbrandsShowBtnTextContainer, repairbrandsShowBtnImgContainer, 'repair-brands__showbtn-img-container--flipped');
  showListHandler(repairdevicesShowBtn, repairdevicesList, 'repair-devices__list--opened', 'repair-devices__list--closed', repairdevicesShowBtnTextContainer, repairdevicesShowBtnImgContainer, 'repair-devices__showbtn-img-container-flipped');
}
...
var isMobileDevice = window.matchMedia('(max-width: 767.9px) and (min-resolution: 150dpi)').matches;
var iPhoneFallback = window.matchMedia('(max-width: 767.9px) and (orientation: portrait)').matches;

var useragentFallback = function useragentFallback() {
...
if (isMobileDevice || iPhoneFallback || useragentFallback()) {
  var swiperContainers = ['.repair-brands__swiper-container', '.repair-devices__swiper-container', '.service-prices__swiper-container'];

  for (var i = 0; i < swiperContainers.length; i++) {
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swiperContainers[i], {
      pagination: {
        el: '.swiper-pagination',
        clickable: true
      },
